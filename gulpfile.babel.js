...
gulp.task("build-dev", ["sass", "icons", "images", "schema", "webpack:build-dev"], function () {
...
gulp.task("sass", function () {
    ...
    .pipe(sass({ includePaths: ["node_modules/normalize-scss/sass", "node_modules/font-awesome/scss"] }))
